            ...
            <form action="{{ route('products.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name') ? old('name') : $item->name }}"
                        {{-- gunanya {{ old('name') ?  old('name') : $item->name }} adalah jika data old ada maka akan di tampilkan, jika tidak maka  akan menmapilkan data di database nya yakni $item->name }} --}} {{-- old gunanya untuk menampilkan data yang sudah pernah di inputkan sebelumnya --}} {{-- invalid error gunanya untuk menanyakan data nya ada atau engga --}}
